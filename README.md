...
### SharedMutex
SharedMutex is a high performance shared mutex best suited to low-write, high-read situations. It has four public functions: shared_lock, shared_unlock, lock, and unlock. SharedMutex is compatible with the std::locks (std::shared/unique_lock, etc) with the functions mentioned previously. Idea and credit [here](https://www.codeproject.com/Articles/1183423/We-Make-a-std-shared-mutex-10-Times-Faster).
